...
![User perspective on PAC-ID resolver](images/pac-id-resolver-user-perspective.svg)
...
5. (Not part of the `PAC-ID Resolver`: The end user software application selects the most appropriate URL)
